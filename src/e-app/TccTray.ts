...
export class TccTray {
    ...
    public async create() {
        ...
        const isTuxedo =
            ...
            (boardVendor !== undefined && boardVendor.toLowerCase().includes('ekimia')) ||
            ...
            (chassisVendor !== undefined && chassisVendor.toLowerCase().includes('ekimia')) ||
            ...
            (sysVendor !== undefined && sysVendor.toLowerCase().includes('ekimia')) ||
